...
describe("API routes", function() {
  beforeEach("Migrate and seed the test database", function() {
    return __awaiter(this, void 0, void 0, function*() {
      yield knex.migrate.rollback();
      yield knex.migrate.latest();
      yield knex.seed.run();
    });
  });
  afterEach("Roll back the database migration", function() {
    return __awaiter(this, void 0, void 0, function*() {
      yield knex.migrate.rollback();
    });
  });
  after("Drain the database pool", function() {
    return __awaiter(this, void 0, void 0, function*() {
      yield knex.destroy();
    });
  });
  describe("GET /api/v1/sightings", function() {
    it("should return all sightings", () =>
      __awaiter(this, void 0, void 0, function*() {
        const response = yield request(server).get("/api/v1/sightings");
  ...
  describe("GET /api/v1/sightings/3", function() {
    it("should return the sighting whose id is 3", () =>
      __awaiter(this, void 0, void 0, function*() {
        const response = yield request(server).get("/api/v1/sightings/3");
        expect(response.statusCode).to.equal(200);
  ...
  describe("POST /api/v1/sightings", function() {
    it("should add a new sighting", () =>
      __awaiter(this, void 0, void 0, function*() {
        const postResponse = yield request(server)
    ...
    it("should return an error on an attempt to add bad data", () =>
      __awaiter(this, void 0, void 0, function*() {
        const postResponse = yield request(server)
          .post("/api/v1/sightings")
          .send({
  ...
  describe("PUT /api/v1/sightings/3", function() {
    it("should change an existing sighting", () =>
      __awaiter(this, void 0, void 0, function*() {
        const putResponse = yield request(server)
    ...
    it("should return an error on an attempt to change the id of an existing sighting", () =>
      __awaiter(this, void 0, void 0, function*() {
        const putResponse = yield request(server)
  ...
  describe("DELETE /api/v1/sightings/1", function() {
    it("should remove an existing sighting", () =>
      __awaiter(this, void 0, void 0, function*() {
        const deletedSighting = yield request(server).delete(
          "/api/v1/sightings/1"
        );
