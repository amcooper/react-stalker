...
export const show = (request: Request, response: Response, next: NextFunction) => {
  return sightingModel
...
export const create = (request: Request, response: Response, next: NextFunction) => {
  return sightingModel
    .create(request.body)
...
export const destroy = (request: Request, response: Response, next: NextFunction) => {
  sightingModel
